...
class VmafossexecQualityRunnerTest(unittest.TestCase):
    ...
    def test_run_vmafossexec_runner_color(self):
            ...
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_vif_scale0_v_score'], 0.30693560416666665, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_vif_scale1_v_score'], 0.8847730208333333, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_vif_scale2_v_score'], 0.9545966458333334, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_vif_scale3_v_score'], 0.9805877916666667, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_vif_v_score'], 0.40664056249999997, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_adm2_v_score'], 0.9169577291666666, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_psnr_v_score'], 40.9919125, places=4)
            self.assertAlmostEqual(results[0]['VMAFOSSEXEC_ssim_v_score'], 0.9478788958333334, places=4)
            ...
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_vif_scale0_v_score'], 1.000000, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_vif_scale1_v_score'], 0.999998, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_vif_scale2_v_score'], 0.999997, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_vif_scale3_v_score'], 0.999996, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_vif_v_score'], 0.999999, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_adm2_v_score'], 1.000000, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_psnr_v_score'], 60.000000, places=4)
            self.assertAlmostEqual(results[1]['VMAFOSSEXEC_ssim_v_score'], 1.000000, places=4)
